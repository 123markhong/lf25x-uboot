...
static const struct uniphier_pinctrl_group uniphier_pro4_groups[] = {
	...
	{
		.name = "ether_rmiib",
		.pins = ether_rmiib_pins,
		.num_pins = ARRAY_SIZE(ether_rmiib_pins),
		.muxvals = ether_rmiib_muxvals,
	},
	...
	UNIPHIER_PINCTRL_GROUP(system_bus_cs0),
	{
		...
		.num_muxvals = ARRAY_SIZE(system_bus_cs1_muxvals),
	},
	...
	{
		.name = "system_bus_cs7",
		.pins = system_bus_cs7_pins,
		.num_pins = ARRAY_SIZE(system_bus_cs7_pins),
		.muxvals = system_bus_cs7_muxvals,
	},
