...
static const struct uniphier_pinctrl_group uniphier_ld6b_groups[] = {
	...
	{
		.name = "ether_rgmii",
		.pins = ether_rgmii_pins,
		.num_pins = ARRAY_SIZE(ether_rgmii_pins),
		.muxvals = ether_rgmii_muxvals,
	},
	{
		.name = "ether_rmii",
	...
	UNIPHIER_PINCTRL_GROUP(spi0),
	{
		...
		.muxvals = spi1_muxvals,
	},
	{
		.name = "system_bus",
		.pins = system_bus_pins,
		.num_pins = ARRAY_SIZE(system_bus_pins),
		.muxvals = system_bus_muxvals,
	},
	{
		.name = "system_bus_cs1",
		.pins = system_bus_cs1_pins,
		.num_pins = ARRAY_SIZE(system_bus_cs1_pins),
		.muxvals = system_bus_cs1_muxvals,
	},
	{
		.name = "system_bus_cs2",
		.pins = system_bus_cs2_pins,
		.num_pins = ARRAY_SIZE(system_bus_cs2_pins),
		.muxvals = system_bus_cs2_muxvals,
	},
	{
		.name = "system_bus_cs3",
		.pins = system_bus_cs3_pins,
		.num_pins = ARRAY_SIZE(system_bus_cs3_pins),
		.muxvals = system_bus_cs3_muxvals,
	},
	{
		.name = "system_bus_cs4",
		.pins = system_bus_cs4_pins,
	...
	},
	{
		.name = "uart0b",
		.pins = uart0b_pins,
		.num_pins = ARRAY_SIZE(uart0b_pins),
		.muxvals = uart0b_muxvals,
	},
	...
	},
	{
		.name = "uart2b",
		.pins = uart2b_pins,
		.num_pins = ARRAY_SIZE(uart2b_pins),
		.muxvals = uart2b_muxvals,
	},
	{
		.name = "usb0",
		.pins = usb0_pins,
		.num_pins = ARRAY_SIZE(usb0_pins),
		.muxvals = usb0_muxvals,
	},
	...
	UNIPHIER_PINCTRL_GROUP(usb2),
	{
		.name = "usb3",
		.pins = usb3_pins,
		.num_pins = ARRAY_SIZE(usb3_pins),
		.muxvals = usb3_muxvals,
	},
};
